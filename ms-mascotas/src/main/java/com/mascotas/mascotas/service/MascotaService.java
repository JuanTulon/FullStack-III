...
public class MascotaService {
    ...
    public MascotaDTO registrarMascota(MascotaCreateDTO request, String emailUsuario) {
        // 1. Validar que el chip no esté registrado ya en el sistema (solo si no es nulo y no está vacío)
        ...
        // Asignamos el dueño desde la sesión autenticada
        mascota.setUsuarioId(getUsuarioIdAutenticado());
    ...
    public MascotaDTO actualizarMascota(Integer id, MascotaUpdateDTO request, String emailUsuario) {
        ...
        if (!mascota.getUsuarioId().equals(getUsuarioIdAutenticado())) {
